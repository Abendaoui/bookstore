...
const Employees = () => {
    ...
    const getEmployees = async (page = 1) => {
        await axiosClient
            .get(`/getadmins/${chosenCustomer}?page${page}`, {
                params: { displayCount: displayCount },
            })
            .then(({ data }) => {
                setMeta(data.meta);
                setEmployeers(data.data);
            })
            .catch((error) => {
                console.log(error);
            });
    ...
    return (
        <section>
            <Breadcrumb />
            {/* Button Component */}
            <LinkButton link={`employee/add`} label="Add New Employee" />
            <Title>List Of Employeers</Title>
            {/* Filter */}
            ...
            <div className="rounded-lg border border-gray-200 shadow-lg m-5">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 bg-gray-100 px-4 py-3 sm:px-6">
                    <Pagination
                        ...
                        onChange={(page) => getEmployees(page)}
...
const Row = ({ id, name, email, profile, created_at, role, getEmployees }) => {
        ...
        <tr className="hover:bg-gray-50">
            ...
            <td className="px-6 py-4 flex">
                <div className="flex justify-end gap-4">
                    <EditIcon link={`/dashboard/employees/edit/${id}`} />
