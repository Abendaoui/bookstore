                    ...
                    <div className="flex flex-col items-center justify-between w-full mb-5 lg:flex-row">
                        ...
                        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
                            ...
                            <div className="flex justify-around items-start space-x-3">
                                <Link
                                    to={`/books/${randombooks[index].slug}`}
                                ...
                                <button className="capitalize border border-dashed border-[#c5a992] hover:bg-[#f6e6da] hover:text-gray-700 transition-colors flex gap-3 p-3 rounded-lg mt-5 text-sm font-semibold">
                                    {t("Shop Now.1")}
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
